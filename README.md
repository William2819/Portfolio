...
uma linguagem de alto nível chamado [Arduino](https://www.arduino.cc/en/Guide/Introduction).
  ...
  Atualmente, estou cursando Análise e Desenvolvimento de Sistemas na FATEC São José dos Campos - Prof. Jessen Vidal. Esta graduação possibilitou-me agregar conhecimentos em múltiplos tipos de linguagem de programação
